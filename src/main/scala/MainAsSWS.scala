...
object MainAsSWS {
  ...
  def main(args: Array[String]): Unit = {
    val elem = FileIO
      .load(
        "/home/freitas/Development/Projects/TAP/1130604_1160907_tap_m1a/files/assessment/ms03/valid_agenda_control_33_in.xml"
      )
      .get
    ...
    FileIO.save("/home/freitas/Desktop/ok9.xml", output)
  }
